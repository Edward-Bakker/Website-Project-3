...
<body class="min-h-full bg-gray-800 text-white">
    ...
    <div class="flex justify-center">
        <form class="flex flex-col bg-gray-600 p-2 rounded m-5" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
            <input class="mb-2 p-1 rounded text-gray-800" name="name" placeholder="Name" id="inputField">
            <input class="mb-2 p-1 rounded text-gray-800" name="team_name" placeholder="Team Name" id="inputField">
            ...
            <input class="mb-2 p-1 rounded text-gray-800" type="password" name="verifyPassword" placeholder="Password" id="inputField">
